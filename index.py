...
def wish():
    ...
    if hour >= 0 and hour<12:
        speak("good morning sir i am Riya for your services")
    elif hour>=12 and hour<18:
        speak("good afternoon sir i am Riya for your services") 
    else:
        speak("good night sir i am Riya for your services")  
